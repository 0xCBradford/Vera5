...
- Name: commandPalette.scan.spec.ts >> command palette scan smoke >> opens palette and runs Scan page on sample-alert fixture
- Location: e2e\commandPalette.scan.spec.ts:23:3
