...
Thank you for helping improve Vera5. This project is an open-source browser extension for analyst-driven IOC enrichment. Contribution guidelines will expand as the extension codebase matures.
...
3. **Match existing style** — Follow patterns in the area you edit once `extension/` and tooling land in the tree.
...
- **Source attribution** — Enrichment UI and exports must show which connector produced each field.
- **Tests** — Add or update unit tests when you change detection, normalization, caching, or connector logic.
